...
def main():
    os.system('title NguyenLucChair')
    colorant = Colorant(CENTER_X - FOV // 2, CENTER_Y - FOV // 2, FOV)
    print(colored('''VER 0.1 - Only Aimbot''', 'yellow'))
    print()
    ...
    print(colored('[Info]', 'green'), colored('Default settings are', 'white'), 
          colored('VK_SHIFT', 'magenta'), colored('= Aimbot,', 'white'), 
          colored('VK_SHIFT', 'magenta'), colored('= Triggerbot', 'white'))
    print(colored('[Info]', 'green'), colored('Made By', 'magenta'), colored('Nguyen Luc', 'magenta'))
    status = 'Disabled'
